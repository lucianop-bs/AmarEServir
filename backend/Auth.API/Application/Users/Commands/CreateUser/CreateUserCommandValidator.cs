using Auth.API.Application.Common.Validators;
...
public class CreateUserCommandValidator : AbstractValidator<CreateUserCommand>
{
    public CreateUserCommandValidator()
    {
        RuleFor(x => x.User.Name)
            .NotEmpty()
            .WithErrorCode(UserErrors.Profile.NameRequired.Code)
        ...
        RuleFor(x => x.User.Phone)
            .NotEmpty()
            .WithErrorCode(UserErrors.Profile.PhoneRequired.Code)
        ...
        RuleFor(x => x.User.Email)
            .NotEmpty()
            .WithErrorCode(UserErrors.Account.EmailRequired.Code)
        ...
        RuleFor(x => x.User.Password)
            ...
            .NotEmpty()
            .WithErrorCode(UserErrors.Account.PasswordRequired.Code)
        ...
        RuleFor(x => x.User.Address)
            .NotNull()
            .WithErrorCode(UserErrors.Address.AddressRequired.Code)
