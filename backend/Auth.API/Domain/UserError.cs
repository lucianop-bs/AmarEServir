...
namespace Auth.API.Domain
{
    public class UserError
    {
        ...
        public static Error RoleInvalid => new("User.RoleInvalid", "Tipo inválido.", ErrorType.Validation);

        public static Error InvalidForRole => new("User.InvalidForRole", "Você não é líder de nenhuma célula.", ErrorType.Validation);

        public static Error AddressRequired => new("User.AddressRequired", "O endereço deve ser preenchido.", ErrorType.Validation);
