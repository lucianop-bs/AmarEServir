...
namespace Auth.API.Domain.Errors
{
    ...
    {
        public static Error NameRequired => new("Cell.NameRequired", "O nome da célula é obrigatório.", ErrorType.Validation);
        ...
        public static Error LeaderNotFound => new("Cell.LeaderNotFound", "O líder não encontrado.", ErrorType.Conflict);
